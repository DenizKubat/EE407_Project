...
float   Kp = 0.003; //related to the proportional control term;
...
void   PID_control() {
  ...
  int motorspeeda = basespeeda + motorspeed;     // Right motor
  int motorspeedb = basespeedb -   motorspeed;   // Left motor
